...
public class Generator {
    ...
    public Generator(boolean upperCase, boolean lowerCase, boolean nums, boolean specialChars, int length) {
    ...
    public void generatePassHandler() {
        ...
        final Generator gen = new Generator(IncludeUpper, IncludeLower, IncludeNum, IncludeSym, length);
        final Password pass = gen.generatePass();

        System.out.println("Your Generated Password:\n" + pass);
        passStrengthHandler(pass);
    }

    public Password generatePass() {
